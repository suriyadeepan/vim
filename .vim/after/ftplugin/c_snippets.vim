...
exec "Snippet readfile1 char * line = NULL;<CR>size_t len = 0;<CR>ssize_t read;<CR>FILE* fp = fopen(\"".st."filename".et."\", \"r\");<CR><CR>char buf[1024];<CR>while((read = getline(&line, &len, fp)) != -1){<CR><CR><CR>}<CR><CR>fclose(fp);<CR>".st.et
